...
import agventure.com.Krish_e.camera_tf.CameraActivity;
import agventure.com.Krish_e.camera_tf.ImageClassifier;

public class KrishiActivity extends AppCompatActivity implements onDeleteIssue, TimelineInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.krishi_activity);
        mWordViewModel = ViewModelProviders.of(this).get(IssueViewModel.class);
        handlePermission();
        actionBar = getSupportActionBar();
        if (actionBar != null) {
            actionBar.setTitle("Krish-e");
        }

        issue_image = findViewById(R.id.issue_image);
        extra_image = findViewById(R.id.extra_img);
        add_layout = findViewById(R.id.add_layout);
        add_img = findViewById(R.id.add_img);
        img_layout = findViewById(R.id.img_layout);

        run_bt = findViewById(R.id.run);
        image_edit = findViewById(R.id.edit_img);

        issue_recycler = findViewById(R.id.issue_list);
        timeline_rec = findViewById(R.id.timeline_rec);
        ...
        add_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (issue_model != null) {
                    ...
                    Toast.makeText(getApplicationContext(), "Please Choose a test case first!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        run_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    String sample = new ImageClassifier(KrishiActivity.this).classifyFrame(bm);
                    Toast.makeText(KrishiActivity.this, sample, Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
...
//                onIssueSelected(issue_recycler.getAdapter().getItemCount(),issueModel);
    ...
    public void measuresView(String diseaseName) {
        ...
        Button linkButton = resetDialog.findViewById(R.id.in_detail);
        Button ok = (Button) resetDialog.findViewById(R.id.ok_button);
        Button cancel = (Button) resetDialog.findViewById(R.id.cancel_button);
        ...
        if (diseaseName.startsWith("pepper red rust")) {
            ...
            linkButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent browserIntent1 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.planetnatural.com/pest-problem-solver/plant-disease/common-rust/"));
                    startActivity(browserIntent1);
                }
            });
        } else if (diseaseName.startsWith("tomato early blight")) {
            steps.setText(getString(R.string.control_steps_tomato_early_blight));
            linkButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.planetnatural.com/pest-problem-solver/plant-disease/early-blight/"));
            ...
            linkButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.cpsskerala.in/OPC/pages/pepperDiseaseLichen.jsp"));
                    startActivity(browserIntent);
                }
            });
            ...
            linkButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.planetnatural.com/pest-problem-solver/plant-disease/bacterial-leaf-spot/"));
                    startActivity(browserIntent);
                }
            });
            ...
            linkButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.cpsskerala.in/OPC/pages/pepperDiseaseFungalPollu.jsp"));
                    startActivity(browserIntent);
                }
            });
        } else {
    ...
    public void onScanClicked() {
        Intent intent = new Intent(KrishiActivity.this, CameraActivity.class);
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(android.support.v7.app.AlertDialog.BUTTON_POSITIVE, "SETTINGS",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        openAppSettings(KrishiActivity.this);
                    }
                });
        alertDialog.show();
    }
